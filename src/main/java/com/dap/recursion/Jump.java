...
/**
 *  实现简单的青蛙跳台阶问题
 *      1、有n阶楼梯，青蛙一次只能跳1层或2层，求有多少中跳法
 *      2、有n阶楼梯，青蛙一次只能调1，2，3，......n阶，求有多少中跳法
 *
 * @author hepeng
...
public class Jump {
    ...
    private static HashMap<Integer, Integer> jumpTimeMap2 = new HashMap<Integer, Integer>();
    ...
    public static int jump1(int n) {
        switch (n) {
            ...
            case 2:
                return 2;
            default : return jump1(n - 1) + jump1(n - 2);
        }
    }
